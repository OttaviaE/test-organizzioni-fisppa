...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# installo pacchetti}
\CommentTok{\#\textgreater{} install.packages("dplyr")}
\CommentTok{\#\textgreater{} install.packages("readr")}
...
fasce: \textbf{basso} (1--2), \textbf{medio-basso} (3--4),
\textbf{medio-alto} (5--7), e \textbf{alto} (8--10). A tale scopo,
creiamo una nuova variabile che rappresenta una versione categorizzata
di \texttt{StressLevel}.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# creo la variabile StressLevel}
\NormalTok{StressCat }\OtherTok{=} \FunctionTok{case\_when}\NormalTok{(burnout}\SpecialCharTok{$}\NormalTok{StressLevel }\SpecialCharTok{\textless{}=} \DecValTok{2} \SpecialCharTok{\textasciitilde{}} \StringTok{"basso"}\NormalTok{,}
\NormalTok{                      burnout}\SpecialCharTok{$}\NormalTok{StressLevel  }\SpecialCharTok{\textgreater{}=} \DecValTok{3} \SpecialCharTok{\&}
\NormalTok{                                burnout}\SpecialCharTok{$}\NormalTok{StressLevel  }\SpecialCharTok{\textless{}=} \DecValTok{4} \SpecialCharTok{\textasciitilde{}} \StringTok{"medio{-}basso"}\NormalTok{,}
\NormalTok{                              burnout}\SpecialCharTok{$}\NormalTok{StressLevel  }\SpecialCharTok{\textgreater{}=} \DecValTok{5} \SpecialCharTok{\&}
\NormalTok{                                burnout}\SpecialCharTok{$}\NormalTok{StressLevel  }\SpecialCharTok{\textless{}=} \DecValTok{7} \SpecialCharTok{\textasciitilde{}} \StringTok{"medio{-}alto"}\NormalTok{,}
\NormalTok{                             burnout}\SpecialCharTok{$}\NormalTok{StressLevel  }\SpecialCharTok{\textgreater{}=} \DecValTok{8} \SpecialCharTok{\textasciitilde{}} \StringTok{"alto"}\NormalTok{ )}
...
\begin{verbatim}
 chr [1:2000] "basso" "basso" "medio-basso" "alto" "basso" "medio-alto" ...
\end{verbatim}
\end{frame}
...
\NormalTok{StressCat }\OtherTok{=} \FunctionTok{ordered}\NormalTok{(StressCat, }
           \AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"basso"}\NormalTok{,}\StringTok{"medio{-}basso"}\NormalTok{,}\StringTok{"medio{-}alto"}\NormalTok{,}\StringTok{"alto"}\NormalTok{))}
...
\begin{verbatim}
 Ord.factor w/ 4 levels "basso"<"medio-basso"<..: 1 1 2 4 1 3 2 2 3 3 ...
\end{verbatim}
...
Quanti hanno hanno riportato un grado di stress inferiore o uguale a
medio-basso?
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{nrow}\NormalTok{(burnout)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(burnout}\SpecialCharTok{$}\NormalTok{StressCat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{=} \FunctionTok{nrow}\NormalTok{(burnout)}
\end{Highlighting}
\end{Shaded}
\end{frame}
...
ha riportato un grado di stress inferiore o uguale a medio-basso.
...
2 & medio-basso & 2 & 399 & 818 & 0.1995 & 0.4090 \\
3 & medio-alto & 3 & 584 & 1402 & 0.2920 & 0.7010 \\
4 & alto & 4 & 598 & 2000 & 0.2990 & 1.0000 \\
\bottomrule\noalign{}
\end{longtable}
\end{frame}
...
\FunctionTok{barplot}\NormalTok{(}\FunctionTok{table}\NormalTok{(burnout}\SpecialCharTok{$}\NormalTok{StressCat), }\AttributeTok{ylab=}\StringTok{"?"}\NormalTok{, }
         \AttributeTok{xlab=}\StringTok{"Accordo"}\NormalTok{,}\AttributeTok{ylim =}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{600}\NormalTok{)) }\CommentTok{\# diagramma a barre}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{0-Descrittiva_files/figure-beamer/unnamed-chunk-13-1.pdf}}
\end{frame}
...
\FunctionTok{barplot}\NormalTok{(}\FunctionTok{table}\NormalTok{(burnout}\SpecialCharTok{$}\NormalTok{StressCat)}\SpecialCharTok{/}\NormalTok{n, }\AttributeTok{ylab=}\StringTok{"?"}\NormalTok{, }
         \AttributeTok{xlab=}\StringTok{"Accordo"}\NormalTok{, }\AttributeTok{ylim =}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{3}\NormalTok{)) }\CommentTok{\# diagramma a barre}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{0-Descrittiva_files/figure-beamer/unnamed-chunk-14-1.pdf}}
\end{frame}
...
\FunctionTok{barplot}\NormalTok{(}\FunctionTok{cumsum}\NormalTok{(}\FunctionTok{table}\NormalTok{(burnout}\SpecialCharTok{$}\NormalTok{StressCat)), }\AttributeTok{ylab=}\StringTok{"?"}\NormalTok{, }
         \AttributeTok{xlab=}\StringTok{"Accordo"}\NormalTok{) }\CommentTok{\# diagramma a barre}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{0-Descrittiva_files/figure-beamer/unnamed-chunk-15-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{0-Descrittiva_files/figure-beamer/unnamed-chunk-16-1.pdf}}
\end{frame}
...
\CommentTok{\# visualizzo i primi elementi}
...
Levels: basso < medio-basso < medio-alto < alto
\end{verbatim}
\end{frame}
