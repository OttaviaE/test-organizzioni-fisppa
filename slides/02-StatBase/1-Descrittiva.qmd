---
title: "Elementi di statistica descrittiva 1"
...
ggplot(data = data_prof, aes(x = voti, fill = prof, color = prof))+
...
La diﬀerenza interquartilica è un indice di variabilità robusto,
...
text(Q1_x,  y + 0.42, expression(Q[1]), cex = 1.1, font = 2)
text(med_x, y + 0.42, expression(Q[2]),              cex = 1.1, font = 2)  # oppure "Med"
text(Q3_x,  y + 0.42, expression(Q[3]), cex = 1.1, font = 2)

# ─── ETICHETTA DENTRO AL BOX ────────────────────────────────────
text((Q1_x + Q3_x)/2, y, "IQR (50%)", col = "white", cex = 1.2, font = 2)
