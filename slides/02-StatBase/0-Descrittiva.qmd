...
La **curtosi** ci da una misura delle distribuzione dei dati nelle code (tails).


| Tipo | Valore indice | Forma |
|:-----|:-------------:|:------|
| **Mesocurtica** | $\approx 3$ | Forma normale |
| **Leptocurtica** | $>3$ | code pesanti |
| **Platicurtica** | $<3$ | code leggere |
...
```{r}
# Calcoliamo la curtosi per la variabile WorkHoursPerWeek
kurtosis(burnout$WorkHoursPerWeek)
```
