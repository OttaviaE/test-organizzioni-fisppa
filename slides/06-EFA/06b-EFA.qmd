...
|---|---|---|
| Diagonale $\sigma_{ii}$ | $\lambda_i^2 + \psi_i$ | Varianza totale = comunalità + unicità |
| Fuori diagonale $\sigma_{ij}$ | $\lambda_i \lambda_j$ | Covarianza riprodotta tra item $i$ e $j$ |
