...
La funzione `rep()` permette di ripetere gli elementi di un vettore, e quindi ci permette per esempio di creare un fattore a tre livelli  "hello","ciao" e "hola", e definire che per ogni livello abbiamo 2 osservazioni

```{r, echo=TRUE}
rep(c("hello","ciao", "hola"), each = 2)
