...
- La **distanza tra soglie consecutive** indica quanto è "larga" quella
  categoria: soglie vicine indicano che quella categoria copre un intervallo ristretto del tratto, e quindi discrimina poco tra i rispondenti
...
categoria **3** (cioè tra $\tau_2$ e $\tau_3$)?
Qual'è la probabiltà di rispondere 3?
...
proporzione attesa di risposte 1 (lo stesso `pnorm()` che abbiamo usato per interpretare le soglie nella sezione precedente).
